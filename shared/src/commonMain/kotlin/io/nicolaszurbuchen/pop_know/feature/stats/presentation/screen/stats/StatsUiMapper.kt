...
private fun FullStats.toUiModel() =
    StatsDataUiModel(
...
private fun CategoryStats.toUiModel() =
    StatsCategoryUiModel(
        category = category.toUiModel(),
        answerStats = answerStats.toUiModel(),
    )

private fun DifficultyStats.toUiModel() =
    StatsDifficultyUiModel(

    ...
    override val values = sequenceOf(
        ...
        QuizUiModel(
            ...
            quizData = QuizDataUiModel(
                ...
                choices = listOf(
                    QuizChoiceUiModel("A", "Red", null),
                    QuizChoiceUiModel("B", "Blue", null),
                    QuizChoiceUiModel("C", "Green", AnswerStatusUiModel.CORRECT),
                    QuizChoiceUiModel("D", "Yellow", null),
                ),
                resultChoice = QuizChoiceUiModel("C", "Green", AnswerStatusUiModel.CORRECT),
                totalQuestions = 10,
                currentIndex = 0,
                isAnswered = true,
                isLastQuestion = false,
        ...
        QuizUiModel(
            ...
            quizData = QuizDataUiModel(
                ...
                scoreText = "0/1",
                choices = listOf(
                    QuizChoiceUiModel("A", "True", AnswerStatusUiModel.INCORRECT),
                    QuizChoiceUiModel("B", "False", AnswerStatusUiModel.CORRECT),
                ),
                resultChoice = QuizChoiceUiModel("A", "True", AnswerStatusUiModel.INCORRECT),
                totalQuestions = 10,
                currentIndex = 1,
                isAnswered = true,
                isLastQuestion = false,
        ...
        QuizUiModel(
            ...
            quizData = QuizDataUiModel(
                ...
                choices = listOf(
                    ...
                    QuizChoiceUiModel("B", "Paris", AnswerStatusUiModel.CORRECT),
                    QuizChoiceUiModel("C", "London", null),
                    QuizChoiceUiModel("D", "Madrid", null),
                ),
                resultChoice = QuizChoiceUiModel("", "", AnswerStatusUiModel.TIMEOUT),
                totalQuestions = 10,
                currentIndex = 2,
                isAnswered = true,
                isLastQuestion = false,
